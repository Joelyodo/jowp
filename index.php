                     ...
                     <div class="row d_flex">
                        ...
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                           <div class="best_img">
                              ...
                              <figure><img src="<?php echo get_template_directory_uri().'/assets/images/beimg.png'; ?>"></figure>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row d_flex">
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                           <div class="best_img croos_rt">
                              <h4>Best Design Of Ring</h4>
                              <figure><img src="<?php echo get_template_directory_uri().'/assets/images/beimg2.png'; ?>"></figure>
                           </div>
                        </div>
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                     ...
                     <div class="row d_flex">
                        ...
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                           <div class="best_img d_none">
                              <h4>Best Design Of Ring</h4>
                              <figure><img src="<?php echo get_template_directory_uri().'/assets/images/beimg3.png'; ?>"></figure>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                  <div class="rable-box">
                     <figure>
                     <img src="<?php echo get_template_directory_uri().'/assets/images/cac.png'; ?>" alt="#" />
                  </div>
               </div>
            </div>
         </div>
                              ...
                              <div class="carousel-caption">
                                 <div class="row d_flex">
                                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 pa_rile">
                                       <div class="img_box">
                                          <i><img src="<?php echo get_template_directory_uri().'/assets/images/icon_1.png'; ?>" alt="#"/></i>
                                          <figure><img src="<?php echo get_template_directory_uri().'/assets/images/clients.png'; ?>" alt="#"/></figure>
                                       </div>
                                    </div>
